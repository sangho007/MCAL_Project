...
#define GPT_DELIVERY                   (STD_ON)
#define SPI_DELIVERY                   (STD_ON)
...
#define FEE_DELIVERY                   (STD_ON)
#define FLS_DELIVERY                   (STD_ON)
#define FLSLOADER_DELIVERY             (STD_ON)
#define HSSL_DELIVERY                  (STD_OFF)
#define WDG_DELIVERY                   (STD_ON)
