...
REM *  VERSION   : 1.1.0                                                      **
REM *                                                                         **
REM *  DATE,TIME : 2021-08-05, 17:01:17                                       **
REM *                                                                         **
...
SET GPT_DELIVERY=STD_ON
SET SPI_DELIVERY=STD_ON
...
SET FEE_DELIVERY=STD_ON
SET FLS_DELIVERY=STD_ON
SET FLSLOADER_DELIVERY=STD_ON
SET HSSL_DELIVERY=STD_OFF
SET GTM_DELIVERY=STD_ON
SET WDG_DELIVERY=STD_ON
