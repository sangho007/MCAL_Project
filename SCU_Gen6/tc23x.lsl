...
#endif
#ifndef TRAPTAB
#define TRAPTAB         (INTTAB + 0x2000)      /* start address of trap table */
#endif
...
derivative tc23x
{
        ...
        bus sri
        {
                ...
                map (dest=bus:tc0:fpi_bus, src_offset=0, dest_offset=0, size=0x70000000);
#ifndef __NO_VTC
